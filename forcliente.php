        ...
        <head>
            ...
            <script type="text/javascript">
                $(document).ready(function() {
                    $("#tlfcliente").mask("<?php echo PHONE; ?>");
                });
            </script>
      ...
      *********************************************************************************************************************************************************** -->
                ...
                <section id="main-content">
                    <section class="wrapper">
                        <h3><i class="fa fa-tasks"></i> Módulo Registro de Clientes</h3><br>
                            ...
                            <div class="col-lg-12">
                                <div class="panel panel-border panel-warning widget-s-1">
                                    <div class="panel-heading">
                                        <h4 class="mb"><i class="fa fa-edit"></i> Formulario para Registro de Clientes</h4>
                                    </div>
                                    <div class="panel-body">
                                        <form class="form-horizontal" method="post" action="#" name="clientes" id="clientes">

                                            <div id="error">
                                                <!-- error will be shown here ! -->
                                            </div>
                                            <div class="form-group has-feedback">
                                                <label class="col-sm-2 col-sm-2 control-label"><?php echo DNI; ?> de Cliente: <span class="symbol required"></span></label>
                                                <div class="col-sm-10">
                                            ...
                                            <div class="form-group has-feedback">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" name="tlfcliente" id="tlfcliente" onKeyUp="this.value=this.value.toUpperCase();validateNumberPhone(this)" autocomplete="off" placeholder="Ingrese Telefono de Cliente">
