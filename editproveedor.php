      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-tasks"></i> Módulo Actualización de Proveedores</h3><br>
			...
			<div class="row">
						    <div class="col-lg-12">
                                <div class="panel panel-border panel-warning widget-s-1">
                                    <div class="panel-heading"><h4 class="mb"><i class="fa fa-edit"></i> Formulario para Actualización de Proveedores</h4> </div>
                                    <div class="panel-body">
	         <form class="form-horizontal" name="updateproveedores" id="updateproveedores" method="post" data-id="<?php echo $reg[0]["codproveedor"] ?>">
			 ...
			 <input type="hidden" name="codproveedor" id="codproveedor" value="<?php echo $reg[0]['codproveedor']; ?>">
                                  <input type="text" class="form-control" name="ritproveedor" id="ritproveedor" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Rif de Proveedor" value="<?php echo $reg[0]['ritproveedor']; ?>" required="" aria-required="true">
                        <i class="fa fa-pencil form-control-feedback"></i>
						   ...
						   <div class="form-group has-feedback">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="nomproveedor" id="nomproveedor" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Nombre de Proveedor" value="<?php echo $reg[0]['nomproveedor']; ?>" required="" aria-required="true">
                        <i class="fa fa-pencil form-control-feedback"></i>
                              </div>
                          </div>
						   ...
						   <div class="form-group has-feedback">
                              ...
                              <div class="col-sm-10">
                                   <textarea name="direcproveedor" class="form-control" id="direcproveedor" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Dirección de Proveedor" required="" aria-required="true"><?php echo $reg[0]['direcproveedor']; ?></textarea>
                        <i class="fa fa-map-marker form-control-feedback"></i>
						  ...
						  <div class="form-group has-feedback">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="tlfproveedor" id="tlfproveedor" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" value="<?php echo $reg[0]['tlfproveedor']; ?>" placeholder="Ingrese Telefono de Proveedor" required="" aria-required="true">
                        <i class="fa fa-phone form-control-feedback"></i>
						  ...
						  <div class="form-group has-feedback">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="emailproveedor" id="emailproveedor" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" value="<?php echo $reg[0]['emailproveedor']; ?>" placeholder="Ingrese Correo de Proveedor" required="" aria-required="true">
                        <i class="fa fa-envelope-o form-control-feedback"></i>
						   ...
						   <div class="form-group has-feedback">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="contactoproveedor" id="contactoproveedor" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Persona de Contacto" value="<?php echo $reg[0]['contactoproveedor']; ?>" required="" aria-required="true">
