			...
			<div class="row">
						    <div class="col-lg-12">
                                <div class="panel panel-border panel-warning widget-s-1">
                                    <div class="panel-heading"><h4 class="mb"><i class="fa fa-edit"></i> Formulario para Registro de Proveedores</h4> </div>
				...
				<form class="form-horizontal" method="post"  action="#" name="proveedores" id="proveedores">
                        ...
                        <i class="fa fa-map-marker form-control-feedback"></i>
						  ...
						  <div class="form-group has-feedback">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="tlfproveedor" id="tlfproveedor" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Telefono de Proveedor" required="" aria-required="true">
