        ...
        <head>
            ...
            <script type="text/javascript">
                $(document).ready(function() {
                    $("#tlfempresa").mask("<?php echo PHONE; ?>");
                    $("#tlfresponsable").mask("<?php echo PHONE; ?>");
                });
            </script>
                                    ...
                                    <div class="panel-body">
                                        <form class="form-horizontal" method="post" data-id="<?php echo $reg[0]["id"] ?>" action="#" name="configuracion" id="configuracion">
                                            ...
                                            <div class="form-group has-feedback">
                                                <label class="col-sm-2 col-sm-2 control-label"><?php echo IDENTIFICACION; ?> de Empresa: <span class="symbol required"></span></label>
                                                <div class="col-sm-10">
                                                    <input type="hidden" name="id" id="id" value="<?php echo $reg[0]['id']; ?>">
                                                    <input type="text" class="form-control" name="rifempresa" id="rifempresa" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese <?php echo IDENTIFICACION; ?> de Empresa" value="<?php echo $reg[0]['rifempresa']; ?>" required="" aria-required="true">
                                            ...
                                            <div class="form-group has-feedback">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" name="tlfempresa" id="tlfempresa" onKeyUp="this.value=this.value.toUpperCase();validateNumberPhone(this)" autocomplete="off" placeholder="Ingrese Telefono de Empresa" value="<?php echo $reg[0]['tlfempresa']; ?>" required="" aria-required="true">
                                                    <i class="fa fa-phone form-control-feedback"></i>
                                                </div>
                                            </div>

                                            <div class="form-group has-feedback">
                                                <label class="col-sm-2 col-sm-2 control-label"><?php echo DNI; ?> Responsable: <span class="symbol required"></span></label>
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" name="cedresponsable" id="cedresponsable" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese <?php echo DNI; ?> de Responsable" value="<?php echo $reg[0]['cedresponsable']; ?>" required="" aria-required="true">
                                                    <i class="fa fa-pencil form-control-feedback"></i>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group has-feedback">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" name="tlfresponsable" id="tlfresponsable" onKeyUp="this.value=this.value.toUpperCase();validateNumberPhone(this)" autocomplete="off" placeholder="Ingrese Telefono de Responsable" value="<?php echo $reg[0]['tlfresponsable']; ?>" required="" aria-required="true">
                                                    <i class="fa fa-phone form-control-feedback"></i>
                                                </div>
                                            </div>

                                            <div class="form-group has-feedback">
                                                <label class="col-sm-2 col-sm-2 control-label"><?php echo IMPUESTO; ?> de Ventas: <span class="symbol required"></span></label>
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control number" name="ivav" id="ivav" onKeyPress="EvaluateText('%f', this);" onBlur="this.value = NumberFormat(this.value, '2', '.', '')" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese <?php echo IMPUESTO; ?> de Ventas" value="<?php echo $reg[0]['ivav']; ?>" required="" aria-required="true">
                                                    <i class="fa fa-usd form-control-feedback"></i>
                                                </div>
                                            </div>

                                            <div class="form-group has-feedback">
                                                <label class="col-sm-2 col-sm-2 control-label"><?php echo IMPUESTO; ?> de Servicios: <span class="symbol required"></span></label>
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control number" name="ivas" id="ivas" onKeyPress="EvaluateText('%f', this);" onBlur="this.value = NumberFormat(this.value, '2', '.', '')" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese <?php echo IMPUESTO; ?> de Servicios" value="<?php echo $reg[0]['ivas']; ?>" required="" aria-required="true">
                                                    <i class="fa fa-usd form-control-feedback"></i>
                                                </div>
                                            </div>

                                            <div class="form-group has-feedback">
                                                <label class="col-sm-2 col-sm-2 control-label"><?php echo IMPUESTO; ?> de Compras: <span class="symbol required"></span></label>
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control number" name="ivac" id="ivac" onKeyPress="EvaluateText('%f', this);" onBlur="this.value = NumberFormat(this.value, '2', '.', '')" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese <?php echo IMPUESTO; ?> de Compras" value="<?php echo $reg[0]['ivac']; ?>" required="" aria-required="true">
                                                    <i class="fa fa-usd form-control-feedback"></i>
                                                </div>
                                            </div>
