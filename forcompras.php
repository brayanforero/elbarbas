...
<input class="form-control number" type="text" name="precio2" id="precio2" onKeyPress="EvaluateText('%f', this);" onBlur="this.value = NumberFormat(this.value, '2', '.', '')" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Precio de Venta">                                                 
							...
							<div class="row">	 
										  ...
										  <div class="col-md-4"> 
                                                 <div class="form-group"> 
                                                    <label for="field-4" class="control-label">Tiene <?php echo IMPUESTO; ?> el Producto: <span class="symbol required"></span></label> 
...
<table width="302" id="carritototal">
                        ...
                        <tr>
        <td><span class="Estilo9"><label><?php echo IMPUESTO." ".$con[0]['ivac']; ?>%<input name="iva" id="iva" type="hidden" value="<?php echo $con[0]['ivac'] ?>"  /></label></span></td>
