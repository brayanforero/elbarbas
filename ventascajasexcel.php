...
echo $hoy = "VENTAS_DESDE_".$_GET["desde"]."_HASTA_".$_GET["hasta"]."_CAJA_N°_".$ca[0]['nrocaja'];
  ...
  <tr>
    <td><table width="695" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000">
         <tr>
           ...
           <th>Fecha Venta</th>
           <th>Articulos</th>
           <th>Subtotal con <?php echo IMPUESTO; ?></th>
...
elseif($reg[$i]['fechavencecredito'] < date("Y-m-d")) { echo "VENCIDA"; } ?></span></td>
           <td style="text-align: center"><span class="Estilo15"><?php echo $reg[$i]['fechaventa']; ?></span></td>
