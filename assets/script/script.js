      ...
      success: function (response) {
        if (response == "ok") {
          ...
          $("#error").fadeIn(1000, function () {
            $("#error").html(
              "<center><strong> " + response + " </strong></center>"
            );
            setTimeout(function () {
              $("#error").html("");
            }, 5000);
  ...
  function submitForm() {
    ...
    $.ajax({
      ...
      beforeSend: function () {
        $("#errorr").fadeOut();
        $("#btn-recuperar").html(
          '<i class="fa fa-refresh"></i> Verificando...'
        );
      },
      success: function (data) {
        if (data == 1) {
          $("#error2").fadeIn(1000, function () {
            ...
            $("#btn-recuperar").html(
              '<span class="fa fa-check-square-o"></span> Recuperar Clave'
            );
          });
        } else if (data == 2) {
          $("#errorr").fadeIn(1000, function () {
            $("#errorr").html(
              '<center><div class="alert alert-warning"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button><span class="fa fa-info-circle"></span> EL CORREO INGRESADO NO FUE ENCONTRADO ACTUALMENTE !</div></center>'
            );
...
$("document").ready(function () {
  ...
  $("#configuracion").validate({
    ...
    messages: {
      ...
      nomempresa: {
        required: "Ingrese Nombre de Empresa",
      ...
      cedresponsable: {
        required: "Ingrese C&eacute;dula de Responsable",
        digits: "Ingrese solo digitos para C&eacute;dula",
      },
      nomresponsable: {
        required: "Ingrese Nombre de Responsable",
        lettersonly: "Ingrese solo letras para Nombre",
      },
      correoresponsable: {
        required: "Ingrese Correo de Responsable",
        email: "Ingrese un correo valido",
      },
      tlfresponsable: { required: "Ingrese N&deg; de Telefono de Responsable" },
      ivav: {
        required: "Ingrese Iva para Ventas",
        number: "Ingrese solo numeros con dos decimales para Iva de Ventas",
      },
      ivas: {
        required: "Ingrese Iva para Servicios",
        number: "Ingrese solo numeros con dos decimales para Iva de Servicios",
      },
    },
    submitHandler: submitForm,
  });
    ...
    $.ajax({
      ...
      success: function (data) {
        if (data == 1) {
          ...
          $("#error").fadeIn(1000, function () {
            $("#error").html(
              '<center><div class="alert alert-warning"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button><span class="fa fa-info-circle"></span> ESTE NOMBRE DE CATEGORIA YA SE ENCUENTRA REGISTRADA, VERIFIQUE NUEVAMENTE POR FAVOR !</div></center>'
            );
    ...
    $.ajax({
      ...
      success: function (data) {
        if (data == 1) {
          ...
          $("#error").fadeIn(1000, function () {
            $("#error").html(
              '<center><div class="alert alert-warning"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button><span class="fa fa-info-circle"></span> ESTE NOMBRE DE CAJA YA SE ENCUENTRA REGISTRADA, VERIFIQUE NUEVAMENTE POR FAVOR !</div></center>'
            );
          ...
          $("#error").fadeIn(1000, function () {
            $("#error").html(
              '<center><div class="alert alert-warning"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button><span class="fa fa-info-circle"></span> ESTE USUARIO YA TIENE UNA CAJA DE VENTAS ASIGNADA, VERIFIQUE NUEVAMENTE POR FAVOR !</div></center>'
            );
...
$("document").ready(function () {
  ...
  $("#retiro").validate({
    ...
    messages: {
      ...
      cantretiro: {
        required: "Ingrese Monto de Retiro",
        number: "Ingrese solo digitos con 2 decimales",
      },
      ...
      $.ajax({
        ...
        success: function (data) {
          if (data == 1) {
            ...
            $("#error").fadeIn(1000, function () {
              $("#error").html(
                '<center><div class="alert alert-warning"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button><span class="fa fa-info-circle"></span> POR FAVOR INGRESE UN MONTO VALIDO PARA RETIRO DE EFECTIVO, VERIFIQUE NUEVAMENTE POR FAVOR !</div></center>'
              );
            ...
            $("#error").fadeIn(1000, function () {
              $("#error").html(
                '<center><div class="alert alert-warning"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button><span class="fa fa-info-circle"></span> ESTA CAJA DE VENTA NO DISPONE DE EFECTIVO ACTUALMENTE, VERIFIQUE NUEVAMENTE POR FAVOR !</div></center>'
              );
            ...
            $("#error").fadeIn(1000, function () {
              $("#error").html(
                '<center><div class="alert alert-warning"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button><span class="fa fa-info-circle"></span> EL MONTO SOLICITADO PARA RETIRO EXCEDE EL LIMITE DE EFECTIVO EN CAJA, VERIFIQUE NUEVAMENTE POR FAVOR !</div></center>'
              );
...
$("document").ready(function () {
  ...
  $("#productos").validate({
    ...
    messages: {
      ...
      preciocompra: {
        required: "Ingrese Precio de Compra de Producto",
        number: "Ingrese solo digitos con 2 decimales",
      },
      precioventa: {
        required: "Ingrese Precio de Venta de Producto",
        number: "Ingrese solo digitos con 2 decimales",
      },
      existencia: {
        required: "Ingrese Cantidad o Existencia de Producto",
      ...
      $.ajax({
        ...
        success: function (data) {
          if (data == 1) {
            ...
            $("#error").fadeIn(1000, function () {
              $("#error").html(
                '<center><div class="alert alert-warning"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button><span class="fa fa-info-circle"></span> YA EXISTE UN PRODUCTO CON ESTE C&Oacute;DIGO, VERIFIQUE NUEVAMENTE POR FAVOR !</div></center>'
              );
    ...
    $.ajax({
      ...
      success: function (data) {
        if (data == 1) {
          $("#error").fadeIn(1000, function () {
            $("#error").html(
              '<center><div class="alert alert-danger"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button><span class="fa fa-info-circle"></span> NO SE HA SELECCIONADO NINGUN ARCHIVO PARA CARGAR !</div></center>'
            );

            $("#btn-cargar").html(
              '<span class="fa fa-cloud-upload"></span> Cargar'
            );
          });
        } else if (data == 2) {
          $("#error").fadeIn(1000, function () {
            $("#error").html(
              '<center><div class="alert alert-warning"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button><span class="fa fa-info-circle"></span> ERROR! ARCHIVO INVALIDO PARA LA CARGA MASIVA DE PRODUCTOS</div></center>'
            );
...
$("document").ready(function () {
  ...
  $("#items").validate({
    ...
    messages: {
      ...
      costoitems: {
        required: "Ingrese Costo de Items",
        number: "Ingrese solo digitos con 2 decimales",
      },
      ...
      $.ajax({
        ...
        success: function (data) {
          if (data == 1) {
            ...
            $("#error").fadeIn(1000, function () {
              $("#error").html(
                '<center><div class="alert alert-warning"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button><span class="fa fa-info-circle"></span> ESTE CODIGO DE ITEMS YA SE ENCUENTRA REGISTRADO, VERIFIQUE NUEVAMENTE POR FAVOR !</div></center>'
              );
            ...
            $("#error").fadeIn(1000, function () {
              $("#error").html(
                '<center><div class="alert alert-warning"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button><span class="fa fa-info-circle"></span> ESTE NOMBRE DE ITEMS YA SE ENCUENTRA REGISTRADO, VERIFIQUE NUEVAMENTE POR FAVOR !</div></center>'
              );
...
$("document").ready(function () {
  ...
  $("#clientes").validate({
    ...
    messages: {
      cedcliente: {
        required: "Ingrese C&eacute;dula de Cliente",
        digits: "Ingrese solo digitos para C&eacute;dula",
      },
      nomcliente: { required: "Ingrese Nombre de Cliente" },
      direccliente: { required: "Ingrese Direcci&oacute;n de Cliente" },
      tlfcliente: {
        required: "Ingrese Telefono de Cliente",
        digits: "Ingrese solo digitos",
      },
      emailcliente: {
        required: "Ingrese Email de Cliente",
        email: "Ingrese un Email Valido",
      },
    },
    submitHandler: submitForm,
    ...
    $.ajax({
      ...
      success: function (data) {
        if (data == 1) {
          ...
          $("#error").fadeIn(1000, function () {
            $("#error").html(
              '<center><div class="alert alert-warning"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button><span class="fa fa-info-circle"></span> ESTE CLIENTE YA SE ENCUENTRA REGISTRADO, VERIFIQUE NUEVAMENTE POR FAVOR !</div></center>'
            );
...
$("document").ready(function () {
  ...
  $("#proveedores").validate({
    ...
    messages: {
      ...
      tlfproveedor: {
        required: "Ingrese Telefono de Proveedor",
        digits: "Ingrese solo digitos",
      },
      emailproveedor: {
        required: "Ingrese Email de Proveedor",
        email: "Ingrese un Email Valido",
      },
    ...
    $.ajax({
      ...
      success: function (data) {
        if (data == 1) {
          ...
          $("#error").fadeIn(1000, function () {
            $("#error").html(
              '<center><div class="alert alert-warning"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button><span class="fa fa-info-circle"></span> ESTE PROVEEDOR YA SE ENCUENTRA REGISTRADO, VERIFIQUE NUEVAMENTE POR FAVOR !</div></center>'
            );
    ...
    $.ajax({
      ...
      success: function (data) {
        if (data == 1) {
          ...
          $("#error").fadeIn(1000, function () {
            $("#error").html(
              '<center><div class="alert alert-warning"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button><span class="fa fa-info-circle"></span> NO HA INGRESADO PRODUCTOS PARA PEDIDOS, VERIFIQUE DE NUEVO POR FAVOR !</div></center>'
            );
...
$("document").ready(function () {
  ...
  $("#updatedetallespedidos").validate({
    ...
    messages: {
      ...
      codcategoria: { required: "Seleccione Categoria de Producto" },
      cantpedido: {
        required: "Ingrese Cantidad de Pedido",
        digits: "Ingrese solo digitos",
      },
...
$("document").ready(function () {
  ...
  $("#compras").validate({
    ...
    messages: {
      ...
      fechavencecredito: {
        required: "Ingrese Fecha de Vencimiento de Cr&eacute;dito",
      },
  ...
  function submitForm() {
    ...
    if (total == 0.0) {
      ...
      alert(
        "POR FAVOR DEBE DE AGREGAR PRODUCTOS AL CARRITO PARA CONTINUAR CON LA COMPRA"
      );
        ...
        success: function (data) {
          if (data == 1) {
            $("#error").fadeIn(1000, function () {
              ...
              $("#btn-submit").html(
                '<span class="fa fa-save"></span> Registrar Compras'
              );
            });
          } else if (data == 2) {
            $("#error").fadeIn(1000, function () {
              $("#error").html(
                '<center><div class="alert alert-warning"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button><span class="fa fa-info-circle"></span> NO HA INGRESADO PRODUCTOS PARA ENTRADA EN ALMACEN, VERIFIQUE DE NUEVO POR FAVOR !</div></center>'
              );
...
$("document").ready(function () {
  ...
  $("#updatedetallescompras").validate({
    ...
    messages: {
      ...
      codcategoria: { required: "Seleccione Categoria de Producto" },
      cantcompra: {
        required: "Ingrese Cantidad de Compra",
        digits: "Ingrese solo digitos",
      },
      precio1: {
        required: "Ingrese Precio de Compra",
        number: "Ingrese solo digitos con 2 decimales",
      },
      ...
      $.ajax({
        ...
        success: function (data) {
          if (data == 1) {
            ...
            $("#error").fadeIn(1000, function () {
              $("#error").html(
                '<center><div class="alert alert-danger"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button><span class="fa fa-info-circle"></span> ESTE DETALLE DE COMPRA NO PUEDE SER ACTUALIZADO, SE ENCUENTRA INACTIVO PARA ACTUALIZAR !</div></center>'
              );
...
$("document").ready(function () {
  ...
  $("#ventas").validate({
    ...
    messages: {
      busqueda: {
        required: "Por favor realice la B&uacute;squeda del Cliente",
      },
  ...
  function submitForm() {
    ...
    var nuevaFila =
      "<tr>" +
      "<td colspan=6><center><label>NO HAY PRODUCTOS AGREGADOS</label></center></td>" +
      "</tr>";
    var total = $("#txtTotal").val();
    ...
    /* if (tipopagove=="CREDITO" || dia=="") {
      ...
      $("#producto").css("border-color", "#2b4049");
      alert(
        "POR FAVOR DEBE DE AGREGAR PRODUCTOS AL CARRITO PARA CONTINUAR CON LA VENTA"
      );
      ...
      $.ajax({
        ...
        success: function (data) {
          if (data == 1) {
            ...
            $("#error").fadeIn(1000, function () {
              $("#error").html(
                '<center><div class="alert alert-warning"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button><span class="fa fa-info-circle"></span> NO HA INGRESADO PRODUCTOS PARA VENTAS, VERIFIQUE DE NUEVO POR FAVOR !</div></center>'
              );
            ...
            $("#error").fadeIn(1000, function () {
              $("#error").html(
                '<center><div class="alert alert-warning"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button><span class="fa fa-info-circle"></span> SI EL ABONO DE CREDITO ES MAYOR O IGUAL AL TOTAL DE PAGO DE VENTA, POR FAVOR MODIFIQUE EL TIPO DE PAGO A CONTADO!</div></center>'
              );
            ...
            $("#error").fadeIn(1000, function () {
              ...
              $("#nroautorizacionve").load(
                "funciones.php?muestranroautorizacionve=si"
              );
              $("#muestraformapago").load(
                "funciones.php?BuscaFormaPago=si&tipopago=CONTADO"
              );
              $("#carrito tbody").html("");
              $("#lblsubtotal").text("0.00");
              $("#lblsubtotal2").text("0.00");
        ...
        success: function (data) {
          if (data == 1) {
            $("#error").fadeIn(1000, function () {
              ...
              $("#btn-submit").html(
                '<span class="fa fa-save"></span> Registrar Abono'
              );
            });
          } else if (data == 2) {
            $("#error").fadeIn(1000, function () {
              $("#error").html(
                '<center><div class="alert alert-warning"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button><span class="fa fa-info-circle"></span> POR FAVOR EL MONTO ABONADO ES MAYOR AL QUE DEBE EN ESTA FACTURA DE CREDITO, VERIFIQUE EL MONTO POR FAVOR !</div></center>'
              );
...
$("document").ready(function () {
  ...
  function submitForm() {
    ...
    if (total == 0.0) {
      ...
      $("#producto").css("border-color", "#2b4049");
      alert(
        "POR FAVOR DEBE DE AGREGAR PRODUCTOS AL CARRITO PARA CONTINUAR CON LA DEVOLUCION"
      );
      ...
      $.ajax({
        ...
        success: function (data) {
          if (data == 1) {
            ...
            $("#error").fadeIn(1000, function () {
              $("#error").html(
                '<center><div class="alert alert-warning"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button><span class="fa fa-info-circle"></span> NO HA INGRESADO PRODUCTOS PARA DEVOLUCION, VERIFIQUE DE NUEVO POR FAVOR !</div></center>'
              );
            ...
            $("#error").fadeIn(1000, function () {
              ...
              $("#codigodevolucion").load(
                "funciones.php?muestracodigodevolucion=si"
              );
              $("#carrito tbody").html("");
              $("#lblsubtotal").text("0.00");
              $("#lbliva").text("0.00");
...
$("document").ready(function () {
  ...
  function submitForm() {
    ...
    if (prec == 0.0 || prec == 0) {
      ...
      alert(
        "POR FAVOR INGRESE UN PRECIO VALIDO PARA DEVOLUCI&Oacute;N DE PRODUCTOS"
      );
      ...
      alert(
        "POR FAVOR INGRESE UNA CANTIDAD VALIDA PARA DEVOLUCI&Oacute;N DE PRODUCTOS"
      );
      ...
      $.ajax({
        type: "POST",
        url:
          "editdetalledevolucion.php?coddetalledevolucion=" +
...
$("document").ready(function () {
  ...
  function submitForm() {
    ...
    if (total == 0.0) {
      ...
      alert(
        "POR FAVOR DEBE DE AGREGAR SERVICIOS AL CARRITO PARA CONTINUAR CON LA FACTURA"
      );
      ...
      $.ajax({
        ...
        success: function (data) {
          if (data == 1) {
            ...
            $("#error").fadeIn(1000, function () {
              $("#error").html(
                '<center><div class="alert alert-warning"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button><span class="fa fa-info-circle"></span> NO HA INGRESADO SERVICIOS AL CARRITO PARA FACTURAR, VERIFIQUE DE NUEVO POR FAVOR !</div></center>'
              );
            ...
            $("#error").fadeIn(1000, function () {
              ...
              $("#servicios")[0].reset();
              $("#codigoservicio").load(
                "funciones.php?muestracodigoservicios=si"
              );
              $("#carrito tbody").html("");
              $("#lblsubtotal").text("0.00");
              $("#lbliva").text("0.00");
...
$("document").ready(function () {
  ...
  $("#updatedetallesservicios").validate({
    ...
    messages: {
      ...
      cantservicio: {
        required: "Ingrese Cantidad de Servicio",
        digits: "Ingrese solo digitos",
      },
      precioservicio: {
        required: "Ingrese Precio de Venta",
  ...
  function submitForm() {
    ...
    if (cant <= 0) {
      ...
      $.ajax({
        type: "POST",
        url:
          "editdetalleservicios.php?coddetalleservicio=" + coddetalleservicio,
        data: data,
        beforeSend: function () {
          $("#error").fadeOut();
          $("#btn-update").html(
...
function validateNumberPhone(element) {
