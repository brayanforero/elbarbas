      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-tasks"></i> Módulo General de Servicios Facturados</h3><br>
			...
			<div class="row">
						    <div class="col-lg-12">
                                <div class="panel panel-border panel-warning widget-s-1">
                                    <div class="panel-heading"><h4><i class="fa fa-search"></i> Consulta General de Servicios Facturados</h4> </div>
...
?>
                              <tr>
                                  ...
                                  <td><?php echo number_format($reg[$i]['subtotal'], 2, '.', '.'); ?></td>
                                  <td><?php echo number_format($reg[$i]['totaliva'], 2, '.', '.'); ?></td>
                                  <td><?php echo number_format($reg[$i]['totalpago'], 2, '.', '.'); ?></td>
                                  <td><?php echo date("d-m-Y h:i:s",strtotime($reg[$i]['fechaservicio'])); ?></td>
                                  <td>
<a href="#" title="Ver Factura de Servicios" onClick="VerServicios('<?php echo $reg[$i]['codservicio'] ?>')" class="btn btn-success btn-xs" data-toggle="modal" data-target="#myModal" data-backdrop="static" data-keyboard="false"><i class="fa fa-search-plus"></i></a>
								 
<a href="reportepdf?codservicio=<?php echo base64_encode($reg[$i]['codservicio']); ?>&tipo=<?php echo base64_encode("SERVICIOS") ?>" target="_black" class="btn btn-warning btn-xs" title="Factura de Venta" ><i class="fa fa-print"></i></a>
