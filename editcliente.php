          ...
          <section class="wrapper">
			...
			<div class="row">
			 ...
			 <input type="hidden" name="codcliente" id="codcliente" value="<?php echo $reg[0]['codcliente']; ?>">
                                  <input type="text" class="form-control" name="cedcliente" id="cedcliente" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese <?php echo DNI; ?> de Cliente" value="<?php echo $reg[0]['cedcliente']; ?>" required="" aria-required="true">
