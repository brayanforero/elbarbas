      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-tasks"></i> Módulo General de Clientes</h3><br>
			...
			<div class="row">
						    <div class="col-lg-12">
                                <div class="panel panel-border panel-warning widget-s-1">
                                    <div class="panel-heading"><h4><i class="fa fa-search"></i> Consulta General de Clientes<span class="pull-right"><a href="reportepdf?tipo=<?php echo base64_encode("CLIENTES") ?>" target="_blank" class="btn btn-primary"><span class="fa fa-print"></span> Imprimir Listado</a>&nbsp;<a href="forcliente" class="btn btn-primary"><span class="fa fa-plus"></span> Nuevo Cliente</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></h4> </div>
		...
		if(isset($_GET["mesage"]))
{
	switch($_GET["mesage"])
	{
		...
		echo "<span class='fa fa-check-square-o'></span> EL CLIENTE FUE ELIMINADO EXITOSAMENTE </div></center>"; 
		break;
		
		case 2:
		echo "<center><div class='alert alert-warning'>";
		echo "<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>";
		echo "<span class='fa fa-info-circle'></span> ESTE CLIENTE NO PUEDE SER ELIMINADO, TIENE FACTURAS RELACIONADAS ACTUALMENTE </div></center>";  
		break;
		
		case 3:
		echo "<center><div class='alert alert-warning'>";
		echo "<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>";
		echo "<span class='fa fa-info-circle'></span> USTED NO TIENE ACCESO PARA ELIMINAR CLIENTES, NO ERES EL ADMINISTRADOR DEL SISTEMA </div></center>";  
		break;
...
?>
                              <tr>
                                  ...
                                  <td>
<a href="#" title="Ver Cliente" onClick="VerCliente('<?php echo $reg[$i]['codcliente'] ?>')" class="btn btn-success btn-xs" data-toggle="modal" data-target="#myModal" data-backdrop="static" data-keyboard="false"><i class="fa fa-search-plus"></i></a>
								  
<a href="#" class="btn btn-primary btn-xs" title="Editar" onClick="actualizar('editcliente?codcliente=<?php echo base64_encode($reg[$i]["codcliente"]) ?>')"><i class="fa fa-pencil"></i></a>
                                 
<a href="#" class="btn btn-danger btn-xs" onClick="eliminar('eliminar?<?php echo base64_encode('eliminar'); ?>&codcliente=<?php echo base64_encode($reg[$i]["codcliente"]) ?>&tipo=<?php echo base64_encode("CLIENTES") ?>')" title="Eliminar" ><i class="fa fa-trash-o"></i></a> 
								  </td>
                              </tr>
												<?php  }  ?>
                              </tbody>
