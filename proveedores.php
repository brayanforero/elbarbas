      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-tasks"></i> Módulo General de Proveedores</h3><br>
			...
			<div class="row">
						    <div class="col-lg-12">
                                <div class="panel panel-border panel-warning widget-s-1">
                                    <div class="panel-heading"><h4><i class="fa fa-search"></i> Consulta General de Proveedores<span class="pull-right"><a href="reportepdf.php?tipo=<?php echo base64_encode("PROVEEDORES") ?>" target="_blank" class="btn btn-primary"><span class="fa fa-print"></span> Imprimir Listado</a>&nbsp;<a href="forproveedor.php" class="btn btn-primary"><span class="fa fa-plus"></span> Nuevo Proveedor</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></h4> </div>
		...
		if(isset($_GET["mesage"]))
{
	switch($_GET["mesage"])
	{
		...
		echo "<span class='fa fa-check-square-o'></span> EL PROVEEDOR FUE ELIMINADO EXITOSAMENTE </div></center>"; 
		break;
		
		case 2:
		echo "<center><div class='alert alert-warning'>";
		echo "<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>";
		echo "<span class='fa fa-info-circle'></span> ESTE PROVEEDOR NO PUEDE SER ELIMINADO, TIENE PRODUCTOS RELACIONADAS ACTUALMENTE </div></center>";  
		break;
		
	case 3:
	echo "<center><div class='alert alert-warning'>";
	echo "<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>";
	echo "<span class='fa fa-info-circle'></span> USTED NO TIENE ACCESO PARA ELIMINAR PROVEEDORES DE PRODUCTOS, NO ERES EL ADMINISTRADOR DEL SISTEMA </div></center>";  
		break;
	   ...
	   ?> 
	    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                              ...
                              <tr>
                                  <th>N°</th>
                                  <th><?php echo IDENTIFICACION2; ?></th>
                                  <th>Proveedor</th>
                                  <th>Telefono</th>
                                  <th>Email</th>
                                  <th>Acciones</th>
...
?>
                              <tr>
                                  ...
                                  <td>
<a href="#" title="Ver Proveedor" onClick="VerProveedor('<?php echo $reg[$i]['codproveedor'] ?>')" class="btn btn-success btn-xs" data-toggle="modal" data-target="#myModal" data-backdrop="static" data-keyboard="false"><i class="fa fa-search-plus"></i></a>
								  
<a href="#" class="btn btn-primary btn-xs" title="Editar" onClick="actualizar('editproveedor?codproveedor=<?php echo base64_encode($reg[$i]["codproveedor"]) ?>')"><i class="fa fa-pencil"></i></a>
                                 
<a href="#" class="btn btn-danger btn-xs" onClick="eliminar('eliminar?<?php echo base64_encode('eliminar'); ?>&codproveedor=<?php echo base64_encode($reg[$i]["codproveedor"]) ?>&tipo=<?php echo base64_encode("PROVEEDORES") ?>')" title="Eliminar" ><i class="fa fa-trash-o"></i></a> 
								  </td>
                              </tr>
												<?php  }  ?>
                              </tbody>
