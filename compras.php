  ...
  <body onLoad="muestraReloj()">
    ...
    <div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none">
                                         ...
                                         <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><img src="assets/img/close.png"/></button>
                                                        <h4 class="modal-title" id="myLargeModalLabel">Datos de Factura de Compra de Productos </h4>
                                                    </div>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-tasks"></i> Módulo General de Compras de Productos</h3><br>
			...
			<div class="row">
						    <div class="col-lg-12">
                                <div class="panel panel-border panel-warning widget-s-1">
                                    <div class="panel-heading"><h4><i class="fa fa-search"></i> Consulta General de Compras de Productos<span class="pull-right"><div class="btn-group"><button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown">
						    <span class="fa fa-print"></span> Imprimir Reportes <span class="caret"></span>
						  </button>
						  <ul class="dropdown-menu" role="menu">
<li><a href="reportepdf?tipo=<?php echo base64_encode("COMPRASGENERAL") ?>" target="_blank"><i class="fa fa-file-pdf-o"></i> Listado de Compras (Pdf)</a></li>
<li><a href="comprasexcel"><i class="fa fa-file-excel-o"></i> Listado de Compras (Excel)</a></li>
						  </ul>
						</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></h4> </div>
		...
		if(isset($_GET["mesage"]))
{
	switch($_GET["mesage"])
	{
		...
		echo "<span class='fa fa-check-square-o'></span> LA FACTURA FUE PAGADA EXITOSAMENTE </div></center>"; 
		break;
		
		case 2:
		echo "<center><div class='alert alert-warning'>";
		echo "<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>";
		echo "<span class='fa fa-info-circle'></span> USTED NO TIENE ACCESO PARA PAGAR FACTURA DE COMPRAS DE PRODUCTOS, NO ERES EL ADMINISTRADOR DEL SISTEMA </div></center>";  
		break;
	   ...
	   <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                              ...
                              <tr>
                                  ...
                                  <th>Proveedor</th>
                                  <th>Subtotal</th>
                                  <th>Subtotal <?php echo IMPUESTO; ?> 0%</th>
...
?>
                              <tr>
                                  ...
                                  <td>
<a href="#" class="btn btn-success btn-xs" onClick="VerCompra('<?php echo $reg[$i]['codcompra'] ?>')" data-href="#" data-toggle="modal" data-target=".bs-example-modal-lg" data-placement="left" data-backdrop="static" data-keyboard="false" data-id="" rel="tooltip" title="Ver Compra"><i class="fa fa-search-plus"></i></a>

<?php if($reg[$i]['statuscompra']=="PENDIENTE") { ?><a href="#" title="Status de Compra" onClick="pagar('eliminar?<?php echo base64_encode('eliminar'); ?>&codcompra=<?php echo base64_encode($reg[$i]["codcompra"]) ?>&tipo=<?php echo base64_encode("PAGARFACTURA") ?>')" class="btn btn-info btn-xs"><i class="fa fa-money"></i></a><?php } ?>
								 
<a href="reportepdf?codcompra=<?php echo base64_encode($reg[$i]['codcompra']); ?>&tipo=<?php echo base64_encode("FACTURACOMPRAS") ?>" target="_black" class="btn btn-warning btn-xs" title="Factura de Compra" ><i class="fa fa-print"></i></a>
