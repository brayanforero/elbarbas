...
if (isset($_SESSION['acceso'])) {
	if ($_SESSION['acceso'] == "administrador" || $_SESSION["acceso"] == "vendedor") {
		...
		if (isset($_POST['btn-submit'])) {
			...
			echo '<br><a href="forventas" style="font-size: 20px; display:block; margin: 30px 0; padding: 7px; background-color: lightblue; width: 300px; text-align: center; text-decoration: none; border-radius: 4px;">&#8592; Volver a seccion de ventas</a>';
						...
						<div class="modal-body">
							<form class="form-horizontal" method="post" action="#" name="ventaclientes" id="ventaclientes">
								...
								<div class="form-group has-feedback">
									<label class="col-sm-3 col-sm-3 control-label"><?php echo DNI; ?> Cliente: <span class="symbol required"></span></label>
									<div class="col-sm-9">
										<input type="text" class="form-control" name="cedcliente" id="cedcliente" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese <?php echo DNI; ?> de Cliente" required="" aria-required="true">
								...
								<div class="form-group has-feedback">
									...
									<div class="col-sm-9">
										<input type="text" class="form-control" name="tlfcliente" id="tlfcliente" onKeyUp="this.value=this.value.toUpperCase();validateNumberPhone(this)" autocomplete="off" maxlength="14" placeholder="Ingrese Telefono de Cliente">
										...
										<div class="col-lg-12">
											<div class="panel panel-border panel-warning widget-s-1">
												<div class="panel-heading">
													<h4 class="mb"><i class="fa fa-archive"></i> <strong>Punto de Venta</strong> | <strong>Cajero:</strong> <?php echo $_SESSION['nombres']; ?> | <strong>Caja:</strong> #<?php echo $_SESSION['nrocaja']; ?></h4>
												</div>
														...
														<div class="col-md-12">
															<div class="table-responsive">
																<table class="table table-striped table-bordered dt-responsive nowrap" id="carrito">
																	<thead>
																		<tr>
																			...
																			<th>
																				<div align="center"><?php echo IMPUESTO; ?></div>
																			</th>
																			<th>
																...
																<table width="302" id="carritototal">
																	...
																	<tr>
																		<td width="167"><span class="Estilo9">
																				<label>Subtotal <?php echo IMPUESTO; ?> 0%:</label></span></td>
																		<td width="123">
																	...
																	<tr>
																		<td><span class="Estilo9"><label><?php echo IMPUESTO . " " . $con[0]['ivav']; ?>%<input name="iva" id="iva" type="hidden" value="<?php echo $con[0]['ivav']; ?>" /></label></span></td>
																		<td>
      ...
      *********************************************************************************************************************************************************** -->
								<div class="col-lg-3 ds">
									...
									<div class="form-group">
										...
										<input class="form-control" type="hidden" name="codcliente" id="codcliente"><input class="form-control" type="text" name="busqueda" id="busqueda" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Búsqueda de Cliente" required="required"><small><span class="symbol required"></span> Búsqueda de Cliente: <?php echo DNI; ?> o Nombre</small>
									</div>
