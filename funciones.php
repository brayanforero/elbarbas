<?php include "class/var_config.php"; ?>
...
?><br /><br /><strong><?php  //Mostramos la imagen
    ...
    <tr>
      <td><strong>Tiene <?php echo IMPUESTO; ?>: </strong> <?php echo $reg[0]['ivaproducto']; ?></td>
    </tr>
    <tr>
...
$reg = $tra->ProveedoresPorId();
  ...
  <table border="0" align="center" >
  <tr>
    <td width="350"><strong><?php echo IDENTIFICACION2; ?> de Proveedor:</strong> <?php echo $reg[0]['ritproveedor']; ?></td>
  </tr>
  <tr>
...
?>
														 <tr>
                                                                ...
                                                                <td><div align="center"><?php echo $busq[$i]["producto"]; ?></div></td>
                                                                <td><div align="center"><?php echo $busq[$i]["nomcategoria"]; ?></div></td>
                                                                <td><div align="center"><?php echo number_format($busq[$i]["precio1"]+($busq[$i]["precio1"]*($co[0]["ivac"]/100)), 2, '.', ','); ?></div></td>
                                                                <td><div align="center"><?php echo $busq[$i]["cantcompra"]; ?></div></td>
                                                                <td><div align="center"><?php echo number_format($importe+($importe*($co[0]["ivac"]/100)), 2, '.', ','); ?></div></td>
                                                          </tr>
															<?php } ?>
														    <tr>
															<td colspan="3" rowspan="5">&nbsp;</td>
										<td colspan="2"><div align="right"><strong>SubTotal:</strong></div></td>
														   <td><div align="right"><?php echo number_format($co[0]["subtotalivasic"], 2, '.', ','); ?></div></td>
													      </tr>
													     <tr>
										<td colspan="2"><div align="right"><strong>SubTotal <?php echo IMPUESTO; ?> 0%:</strong></div></td>
														   <td><div align="right"><?php echo number_format($co[0]["subtotalivanoc"], 2, '.', ','); ?></div></td>
										        </tr>
														  <tr>
										<td colspan="2"><div align="right"><strong><?php echo IMPUESTO." ".$co[0]["ivac"]."(%)"; ?>:</strong></div></td>
...
?></div></td>
    ...
    <tr>
      <td><strong>Tiene <?php echo IMPUESTO; ?>: </strong> <?php echo $reg[0]['ivaproductoc']; ?></td>
    </tr>
    <tr>
...
?>
										...
										<td colspan="2"><div align="right"><strong>SubTotal <?php echo IMPUESTO; ?> 0%:</strong></div></td>
														  ...
														  <tr>
										<td colspan="2"><div align="right"><strong><?php echo IMPUESTO." ".$ve[0]["ivave"]."(%)"; ?>:</strong></div></td>
...
?>
														 ...
														 <tr>
														  ...
														  <tr>
														   <td><div align="right"><strong><?php echo IMPUESTO." ".$dev[0]["ivad"]."(%)"; ?> :</strong></div></td>
...
?></div></td>
      <td width="260"><strong><?php echo IDENTIFICACION2; ?> de Proveedor: </strong><?php echo $reg[0]['ritproveedor']; ?></td>
    </tr>
    <tr>
    <td><strong>Nombre de Proveedor:</strong> <?php echo $reg[0]['nomproveedor']; ?></td>
  </tr>
...
?>
														 ...
														 <tr>
														  ...
														  <tr>
														   <td><div align="right"><strong><?php echo IMPUESTO." ".$se[0]["iva"]."(%)"; ?> :</strong></div></td>
